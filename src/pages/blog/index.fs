...
let Posts (props: {| allPostsData: array<obj> |}) =
    Layout
        {| children =
               [ Html.div [ prop.className [ Style.``md:max-w-screen-md``
                                             Style.``mx-auto`` ]
                            prop.children [ Head [ Html.title (Html.text (sprintf "Articles | %s" config.blogTitle)) ]
                                            ...
                                            Html.ul [ prop.className ""
                                                      prop.children (
                                                          ...
                                                          |> Array.map
                                                              (fun (data: obj) ->
                                                                  Html.li [ prop.className [ Style.``my-2`` ]
